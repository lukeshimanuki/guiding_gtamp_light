...
def create_policy(place_holder_config):
    if place_holder_config.atype == 'pick':
        ...
        place_place_holder_config = place_place_holder_config._replace(filtered=True)
        ...
        if place_holder_config.region == 'loading_region':
            ...
            n_collisions = 618
            n_key_configs = 618  # pickle.load(open('placements_%s.pkl' % (place_holder_config.region), 'r'))
