...
def get_s3_path(domain, algorithm, n_objs_pack, commithash, n_iter_limit):
    if 'rsc' in algorithm:
        if 'one' in domain:
            ...
            s3_path = 'csail/bkim/guiding-gtamp/test_results/{}/irsc/one_arm_mover/n_objs_pack_1'.format(commithash[0:7])
        else:
